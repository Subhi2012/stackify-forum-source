...
$lang = array(
	...
	'license'				=> "License",
	'license_inactive'		=> 'Your license is currently inactive. You will need to <a href="{external.renew_my_license}" target="_blank">renew</a> before you can upgrade.',
	'lkey'					=> "License Key",
	'lkey_help'				=> "Help",
	...
	'40000_nexus_modules_desc'			=> "Custom code to run when packages are purchased, etc. cannot be converted during the upgrade. <a href='{external.devdocs-commerce-actions}' target='_blank'>More information</a>",
	...
	'101079_diagnostics_reporting_desc'		=> "This function is currently disabled. | Help Invision Community improve by automatically sending usage and diagnostic information. The data sent does not contain any private information about your users or your community.",
	...
	'hc_files'					=> "File Check",
	'hc_files_ok'				=> "Source files are correct for the latest version",
	'hc_files_fail'				=> "Some source files are not correct for the latest version. If you uploaded the files to your server manually, the process may have failed or not completed yet, or a new version may have been released since you downloaded. Download latest version from your client area and upload the files again in order to continue.",
