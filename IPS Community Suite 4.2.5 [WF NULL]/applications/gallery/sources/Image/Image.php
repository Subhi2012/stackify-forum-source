...
\IPS\Content\MetaData
{
	 ...
	 *
	 * @return	string
	 * @todo	We should look into using JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS here to escape the JSON instead of our manual approach
	 */
	public function json()
	{
		...
		return json_encode( array(
			...
			'state'			=> $state,
			'container' 	=> ( $this->directContainer() instanceof \IPS\gallery\Category ) ? \IPS\Member::loggedIn()->language()->addToStack( "gallery_category_{$this->directContainer()->_id}" ) : $this->directContainer()->_title,
			'id' 			=> $this->_data['id'],
			'url'			=> (string) $this->url(),
			'author'		=> array(
