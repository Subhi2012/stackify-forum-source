...
class _Upgrade
{
	...
	public function step3CustomTitle()
	{
		...
		{
			$_SESSION['_step6Count'] = \IPS\Db::i()->select( 'COUNT(*)', 'core_dnames_change' )->first();
		}

		return "Moving Display Name history to the Member History system (Converted so far: " . ( ( $limit > $_SESSION['_step6Count'] ) ? $_SESSION['_step6Count'] : $limit ) . ' out of ' . $_SESSION['_step6Count'] . ')';
	}
	...
	{
		\IPS\Db::i()->update( 'core_member_ranks', 'pips=100', array('pips>?', 100 ) );
