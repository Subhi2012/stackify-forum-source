...
class _members extends \IPS\Dispatcher\Controller
{
	...
	public function add()
	{
		...
		$form->add( new \IPS\Helpers\Form\Password( 'password', NULL, TRUE, array( 'maxLength' => 50, 'showMeter' => \IPS\Settings::i()->password_strength_meter, 'checkStrength' => TRUE ) ) );
	...
	public function edit()
	{
		...
		\IPS\Output::i()->customHeader = \IPS\Theme::i()->getTemplate( 'members' )->editMemberHeader( $member, \IPS\Member::loggedIn()->hasAcpRestriction( 'core', 'members', 'membertools_ip' ) );
		\IPS\Output::i()->output	= $form;
	}
	...
	protected function password()
	{
		...
		/* Show Form */
		$form = new \IPS\Helpers\Form;
		$form->add( new \IPS\Helpers\Form\Password( 'password', '', TRUE, array( 'maxLength' => 50, 'confirm' => 'password_confirm', 'showMeter' => \IPS\Settings::i()->password_strength_meter, 'minimumStrength' => 1 ) ) );
		$form->add( new \IPS\Helpers\Form\Password( 'password_confirm', '', TRUE, array( 'maxLength' => 50 ) ) );
	...
	public function photo()
	{
		...
		$form->add( new \IPS\Helpers\Form\Radio( 'pp_photo_type', ( $member->pp_photo_type == 'letter' ) ? 'none' : $member->pp_photo_type, TRUE, array( 'options' => $options, 'toggles' => $toggles ) ) );
		$customVal = NULL;
	...
	public function viewDnameHistory()
	{
		...
		$table = new \IPS\Member\History( $member->acpUrl()->setQueryString( array( 'do' => 'viewDnameHistory' ) ), array( array( 'log_member=? AND log_app=? AND log_type=?', $member->member_id, 'core', 'display_name' ) ) );
	...
	public function clearDnameHistory()
	{
		...
		\IPS\Db::i()->delete( 'core_member_history', array( 'log_member=? AND log_app=? AND log_type=?', $member->member_id, 'core', 'display_name' ) );
	...
	public function delete()
	{
		...
		if ( $member->member_posts )
		{
			...
			\IPS\Member::loggedIn()->language()->words['keep_name'] = sprintf( \IPS\Member::loggedIn()->language()->get('keep_name'), $member->name );
	...
	protected function adminPassword()
	{
		...
		$form->add( new \IPS\Helpers\Form\Password( 'new_password', '', TRUE, array( 'maxLength' => 50, 'showMeter' => \IPS\Settings::i()->password_strength_meter, 'checkStrength' => TRUE ) ) );
