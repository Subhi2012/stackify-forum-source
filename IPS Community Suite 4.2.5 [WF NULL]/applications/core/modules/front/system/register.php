...
class _register extends \IPS\Dispatcher\Controller
{
	...
	public static function buildRegistrationForm()
	{
		...
		$form->add( new \IPS\Helpers\Form\Password( 'password_confirm', NULL, TRUE, array( 'maxLength' => 50, 'confirm' => 'password' ) ) );
