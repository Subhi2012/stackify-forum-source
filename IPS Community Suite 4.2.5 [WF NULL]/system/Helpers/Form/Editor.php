...
class _Editor extends FormAbstract
{
	...
	public function html( $raw=FALSE )
	{
		...
		{
			$attachmentArea = \IPS\Theme::i()->getTemplate( 'forms', 'core', 'global' )->editorAttachmentsPlaceholder( $this->name, $this->postKey, $this->noUploaderError );
		}
	...
	protected function getUploader( $name )
	{
		...
		{
			$perPostSpaceRemaining = \IPS\Member::loggedIn()->group['g_attach_per_post'] / 1024;
